...
describe("getDirectorProducerAverages", () => {
  ...
  it("should return an array of objects with the correct properties", () => {
    ...
    expect(getDirectorProducerAverages(sampleData)[0]).toHaveProperty(
      "averageRating"
    );
    expect(getDirectorProducerAverages(sampleData)[0]).toHaveProperty(
      "theirFilms"
  ...
  it("averageRating should return a number less than or equal to 100", () => {
    expect(
      getDirectorProducerAverages(sampleData)[0].averageRating
    ).toBeLessThanOrEqual(100);
    expect(
      getDirectorProducerAverages(sampleData)[1].averageRating
    ).toBeLessThanOrEqual(100);
    expect(
      getDirectorProducerAverages(sampleData)[2].averageRating
    ).toBeLessThanOrEqual(100);
  });
...
describe("getLocationsNameAndImg", () => {
  ...
  it("should return an array of objects with the correct properties", () => {
    ...
    expect(getLocationsNameAndImg(sampleData)[0]).toHaveProperty(
      "surface_water"
    );
  });
  it("should return an array of objects with the correct length", () => {
...
describe("getVehiclesNameAndImg", () => {
  ...
  it("should return an array of objects with the correct properties", () => {
    ...
    expect(getVehiclesNameAndImg(sampleData)[0]).toHaveProperty(
      "vehicle_class"
    );
  ...
  it("should return an array of objects with the correct values", () => {
    expect(getVehiclesNameAndImg(sampleData)[0].name).toBe(
